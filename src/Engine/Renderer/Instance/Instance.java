package Engine.Renderer.Instance;
...
import static Engine.Renderer.ValidationLayers.ValidationLayers.populateDebugMessengerCreateInfo;
...
public class Instance {
    ...
    public VkInstance create(PointerBuffer validationLayers) {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            VkInstanceCreateInfo instanceCreateInfo = VkInstanceCreateInfo.callocStack()
                    ...
                    .ppEnabledExtensionNames(getRequiredExtensions(validationLayers));
